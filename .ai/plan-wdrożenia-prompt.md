...
Twoim zadaniem jest stworzenie kompleksowego planu wdrożenia całej ścieżki interfejsu API REST. Przed dostarczeniem ostatecznego planu użyj znaczników <analysis>, aby przeanalizować informacje i nakreślić swoje podejście. Dla każdego z endpointu i metodu, w tej analizie upewnij się, że:
...
Pamiętaj, aby zapisać swój plan wdrożenia jako .ai/{{nazwa ścieżki}}-implementation-plan.md. Upewnij się, że plan jest szczegółowy, przejrzysty i zapewnia kompleksowe wskazówki dla zespołu programistów.
```
